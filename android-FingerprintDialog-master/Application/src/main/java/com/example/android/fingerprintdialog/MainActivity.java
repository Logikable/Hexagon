...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button purchaseButton2 = (Button) findViewById(R.id.purchase_button_2);
        //Button purchaseButtonNotInvalidated = (Button) findViewById(
                //R.id.purchase_button_not_invalidated);
        View uselessbutton = findViewById(R.id.purchase_button_not_invalidated);
        ...
        purchaseButton2.setOnClickListener(
                new PurchaseButton2ClickListener(defaultCipher, DEFAULT_KEY_NAME));
    ...
    private class PurchaseButton2ClickListener implements View.OnClickListener {

        Cipher mCipher;
        String mKeyName;

        PurchaseButton2ClickListener(Cipher cipher, String keyName) {
            mCipher = cipher;
            mKeyName = keyName;
        }
